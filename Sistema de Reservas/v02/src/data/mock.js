...
export const RESERVATIONS_DATA = [
  { id:"r1",  suiteId:"s2",  suiteName:"Suíte Safira (Spa Urbano)",    motel:"Spa Urbano",  motelId:"spa",    guestName:"Carlos M.",    cpf:"123.456.789-00", protocolo:"RES-2025-001", reservationDate:d(-2,14), checkIn:d(-1,22), checkOut:d(0,6),    type:"pernoite", status:"confirmado",   totalValue:335, paymentMethod:"pix",     paymentStatus:"pago",       asaasPaid:true  },
  { id:"r2",  suiteId:"s6",  suiteName:"Suíte Tahiti (Assahi)",        motel:"Assahi",      motelId:"assahi", guestName:"Fernanda L.",  cpf:"234.567.890-11", protocolo:"RES-2025-002", reservationDate:d(-1,9),  checkIn:d(0,14),   checkOut:null,    type:"rotativo", status:"check-in",      totalValue:180, paymentMethod:"dinheiro",paymentStatus:"pago",       asaasPaid:true  },
  { id:"r3",  suiteId:"s11", suiteName:"Suíte Fórmula 1 (Assahi)",     motel:"Assahi",      motelId:"assahi", guestName:"Ricardo P.",   cpf:"345.678.901-22", protocolo:"RES-2025-003", reservationDate:d(-1,16), checkIn:d(0,16),   checkOut:null,    type:"pernoite", status:"pendente",      totalValue:1092, paymentMethod:"pix",    paymentStatus:"pendente",   asaasPaid:false },
  { id:"r4",  suiteId:"s1",  suiteName:"Suíte Jade (Spa Urbano)",      motel:"Spa Urbano",  motelId:"spa",    guestName:"Paulo & Ana",  cpf:"456.789.012-33", protocolo:"RES-2025-004", reservationDate:d(0,10),  checkIn:d(1,20),   checkOut:d(2,8),  type:"pernoite", status:"pagar-motel",   totalValue:300, paymentMethod:"pix",     paymentStatus:"pendente",   asaasPaid:false },
  { id:"r5",  suiteId:"s4",  suiteName:"Suíte Esmeralda (Spa Urbano)", motel:"Spa Urbano",  motelId:"spa",    guestName:"Marcos T.",    cpf:"567.890.123-44", protocolo:"RES-2025-005", reservationDate:d(0,11),  checkIn:d(1,22),   checkOut:d(2,6),  type:"pernoite", status:"aguardando",    totalValue:791, paymentMethod:"cartao",  paymentStatus:"pendente",   asaasPaid:false },
  { id:"r6",  suiteId:"s12", suiteName:"Suíte Sonho (Dragon)",         motel:"Dragon",      motelId:"dragon", guestName:"Lúcia M.",     cpf:"678.901.234-55", protocolo:"RES-2025-006", reservationDate:d(1,8),   checkIn:d(2,10),   checkOut:null,    type:"rotativo", status:"pendente",      totalValue:193, paymentMethod:"pix",     paymentStatus:"pendente",   asaasPaid:false },
  { id:"r7",  suiteId:"s5",  suiteName:"Suíte Diamante (Spa Urbano)",  motel:"Spa Urbano",  motelId:"spa",    guestName:"Henrique S.",  cpf:"789.012.345-66", protocolo:"RES-2025-007", reservationDate:d(1,15),  checkIn:d(3,22),   checkOut:d(4,8),  type:"pernoite", status:"aguardando",    totalValue:986, paymentMethod:"cartao",  paymentStatus:"pendente",   asaasPaid:false },
  { id:"r8",  suiteId:"s7",  suiteName:"Suíte Bora Bora (Assahi)",     motel:"Assahi",      motelId:"assahi", guestName:"Roberta K.",   cpf:"890.123.456-77", protocolo:"RES-2025-008", reservationDate:d(-3,10), checkIn:d(-2,20),  checkOut:d(-1,6), type:"pernoite", status:"confirmado",    totalValue:384, paymentMethod:"pix",     paymentStatus:"pago",       asaasPaid:true  },
  { id:"r9",  suiteId:"s18", suiteName:"Suíte Sonho (Dreams)",         motel:"Dreams",      motelId:"dreams", guestName:"Felipe N.",    cpf:"901.234.567-88", protocolo:"RES-2025-009", reservationDate:d(0,7),   checkIn:d(0,18),   checkOut:null,    type:"rotativo", status:"check-in",      totalValue:167, paymentMethod:"dinheiro",paymentStatus:"pago",       asaasPaid:true  },
  { id:"r10", suiteId:"s3",  suiteName:"Suíte Rubi (Spa Urbano)",      motel:"Spa Urbano",  motelId:"spa",    guestName:"Camila R.",    cpf:"012.345.678-99", protocolo:"RES-2025-010", reservationDate:d(2,13),  checkIn:d(4,22),   checkOut:d(5,8),  type:"pernoite", status:"cancelado",     totalValue:377, paymentMethod:"pix",     paymentStatus:"cancelado",  asaasPaid:false },
  { id:"r11", suiteId:"s13", suiteName:"Suíte Inspiração (Dragon)",    motel:"Dragon",      motelId:"dragon", guestName:"Bruno S.",     cpf:"111.222.333-44", protocolo:"RES-2025-011", reservationDate:d(-4,16), checkIn:d(-3,22),  checkOut:d(-2,6), type:"pernoite", status:"confirmado",    totalValue:473, paymentMethod:"cartao",  paymentStatus:"pago",       asaasPaid:true  },
  { id:"r12", suiteId:"s20", suiteName:"Suíte Sonho Amado (Dreams)",   motel:"Dreams",      motelId:"dreams", guestName:"Juliana V.",   cpf:"222.333.444-55", protocolo:"RES-2025-012", reservationDate:d(1,9),   checkIn:d(2,22),   checkOut:d(3,8),  type:"pernoite", status:"aguardando",    totalValue:357, paymentMethod:"cartao", paymentStatus:"pendente",   asaasPaid:false },
];
